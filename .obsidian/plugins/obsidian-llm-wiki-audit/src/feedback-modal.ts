...
export class FeedbackModal extends Modal {
  ...
  openAndAwait(): Promise<FeedbackModalResult | null> {
  ...
  onOpen(): void {
    ...
    for (const sev of SEVERITIES) {
      ...
      const input: HTMLInputElement = label.createEl("input", {
    ...
    const textarea: HTMLTextAreaElement = commentField.createEl("textarea", {
      cls: "audit-comment",
    });
