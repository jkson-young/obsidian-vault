...
var LLMWikiAuditSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Wiki root path").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Audit directory path").setDesc("Path relative to the wiki root where audit files are written.").addText(
